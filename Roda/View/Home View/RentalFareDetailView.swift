...
class RentalFareDetailView: UIView {
    ...
    func setupViews(Base baseView: UIView) {
        ...
        viewTotal.addShadow()
        viewTotal.backgroundColor = .secondaryColor//.hexToColor("EAEAEA")
        ...
        lblTotalHint.textColor = .txtColor
        lblTotalHint.font = UIFont.appRegularFont(ofSize: 20)
        ...
        viewTotal.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-8-[lblTotalAmount(40)][lblEstimation]-8-[lblTotalHint]-8-|", options: [APIHelper.appLanguageDirection,.alignAllLeading,.alignAllTrailing], metrics: nil, views: layoutDict))
