...
class HistoryDetailsView: UIView {
    ...
    func setupViews(Base baseView: UIView) {
       ...
       // addressView.addShadow()
        ...
        containerView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-(15)-[addressView]-10-[driverDetailView]-10-[distanceDetailView]-5-[stackOutstation]-15-|", options: [], metrics: nil, views: layoutDict))
